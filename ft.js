const quotes = [
    ...
    `"adhrit is still and forever single" - anonymous`,
    `"+6715859213 looking for one night stand, only baddies 10 out of 10 no fatties" - justdoit`,
    `"+971504341439" - zechen`,
    `"+971563756377 - this is tyler girlfriend" - someone`,
    ...
    `"I hate sol" - Everyone`,
    `"You are either me or black - Matias`,
    `"I'm not gay" - Tyler"`,
    `"Im gay from Adhrit" - Adhrit`,
    ...
    `"Still hungry" - Y.`,
    `"Guess what I pulled? A push door." - AA`,
